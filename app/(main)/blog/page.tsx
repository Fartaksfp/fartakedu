...
const posts = [
  {
    ...
    excerpt:
      "چطور هوش مصنوعی می‌تواند عملیات کسب‌وکار شما را بهبود دهد و بهره‌وری را افزایش دهد.",
    date: "1404-7-25",
    category: "هوش مصنوعی",
    ...
    <main className="container mx-auto pt-30 px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {posts.map((post) => (
          <div
            key={post.id}
            className="bg-white dark:bg-slate-950 rounded-lg shadow hover:shadow-xl transition overflow-hidden"
          >
            <Image
              src={post.image}
              width={200}
            ...
            <div className="p-6">
              ...
              <Link href="#" className="mt-4 inline-block text-blue-600">
                <Button>
                  ادامه مطلب <ChevronLeft className="-mt-0.5" />
                </Button>
              </Link>
            </div>
          </div>
